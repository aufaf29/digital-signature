...
key_size = StringVar(tab1); key_size.set(key_size_option[2]);
key_size_dropdown = OptionMenu(tab1, key_size, *key_size_option)

generate_key_button = Button(tab1, height = 2, width = 60, text ="Generate Key", command = lambda: generate_key())

key_1 = Text(tab1, height = 5, width = 60)
key_2 = Text(tab1, height = 5, width = 60)

plaintext = Text(tab1, height = 5, width = 60)
encrypt_button = Button(tab1, height = 2, width = 60, text ="Encrypt!", command = lambda: encrypt())

ciphertext = Text(tab1, height = 5, width = 60)
decrypt_button = Button(tab1, height = 2, width = 60, text ="Decrypt!", command = lambda: decrypt())
